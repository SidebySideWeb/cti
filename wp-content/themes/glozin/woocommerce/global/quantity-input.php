...
$qty_class = $type == 'hidden' ||  $max_value === 1 ? 'hidden' : '';
$qty_class = ! empty( $args['classes_style'] ) ?  $args['classes_style'] . ' ' . $qty_class : $qty_class;
do_action( 'glozin_woocommerce_before_quantity', $type );
